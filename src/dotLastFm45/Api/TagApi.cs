...
namespace DotLastFm45.Api
{
	...
	public class TagApi : LastFmApiBase, ITagApi
	{
		...
		{
			FluentRestWrapper call = Rest.Method("tag.getTopTags");
		...
		{
			FluentRestWrapper call = Rest.Method("tag.getSimilar").AddParam("tag", tag);
		...
		{
			FluentRestWrapper call = Rest.Method("tag.getInfo").AddParam("tag", tag);
		...
		{
			FluentRestWrapper call = Rest.Method("tag.getTopArtists").AddParam("tag", tag);
		...
		{
			FluentRestWrapper call = Rest.Method("tag.getTopAlbums").AddParam("tag", tag);
		...
		{
			FluentRestWrapper call = Rest.Method("tag.getTopTracks").AddParam("tag", tag);
