...
namespace DotLastFm45.Api
{
	...
	public class TrackApi : LastFmApiBase, ITrackApi
	{
		...
		{
			FluentRestWrapper call = Rest.Method("track.getTopTags")
		...
		{
			FluentRestWrapper call = Rest.Method("track.getInfo")
			                             .AddParam("artist", artist)
			                             .AddParam("track", track)
			                             .AddParam("autocorrect", autocorrect ? "1" : "0");
		...
		{
			FluentRestWrapper call = Rest.Method("track.getSimilar")
			                             .AddParam("artist", artist)
			                             .AddParam("track", track)
			                             .AddParam("autocorrect", autocorrect ? "1" : "0");
